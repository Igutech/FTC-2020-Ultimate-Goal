...
public class PIDFControllers {
     ...
     */
    public PIDFControllers(double[] coeff) {
        this(coeff, 0, 0, 0.02);
    }
     ...
     */
    public PIDFControllers(double[] coeff, double sp, double pv, double period) {
        kP = coeff[0];
        kI = coeff[1];
        kD = coeff[2];
        kF = coeff[3];
    ...
    /**
     * Returns the current setpoint of the PIDFControllers.
     *
    ...
    /**
     * Sets the setpoint for the PIDFControllers
     *
